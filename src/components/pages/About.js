export default function About() {
    return (
        <article className="about-page">
            ...
            <hr />
            <p style={{color: "red"}}>NOTE: I'm currently updating the app according to new database structure & security rules, so some of features, like create new account, delete an account, update article or blog are off for a few days...</p>
            <ul>
